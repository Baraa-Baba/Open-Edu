...
export const GSSubjectOptions = [
  {
    name:'mathematics', units: [
      { name: 'revision'},
      { name: 'Functions', lessons: ['function', 'Logarithmic function', 'exponential function', 'Integrals', 'Differential Equations'] },
      { name: 'Sequence'},
  ...
  export const LSSubjectOptions = [
    {
      name:'mathematics', units: [
        { name: 'revision'},
        { name: 'Functions', lessons: ['function', 'Logarithmic function', 'exponential function', 'Integrals'] },
        { name: 'Probability, combinatorial', lessons: ['Conditional Probability', 'Permutations', 'Combinations'] },
        { name: 'Lines and Planes'},
      ]
    },
    ...
    },
    {
      name: 'chemistry', units: [
        { name: 'revision' },
        { name: 'Chemical Kinetics', lessons: ['chemical kinetics and kinetic factors', 'chemical equilibrium'] } ,
        { name: 'acid - base', lessons: ['strong acid - strong base - pH metric titration', 'weak acid - weak base Conjugate Acid/Base pair', 'Reaction between a Weak Acid and a Strong Base'] },
  ...
  export const SATSubjectOptions = [ 
          {name: 'english'},
          {name:'mathematics'}
        ]
export const typeApplcation = [{ name: 'explantion' }, { name: 'extra' }]
