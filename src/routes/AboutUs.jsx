...
export default function AboutUs() {
  return ( 
    ...
    <div class="container">
        ...
        <div class="container-body">
            <p><span class="first-letter">A</span>t FEKRA we highly values student collaboration.
               ...
               Students can share teaching materials using the <a href="collaborate.html">collaborate</a> button.
            </p>
        </div>
    </div>
    <div class="container">
        ...
        <div class="container-body">
            <p> <span class="first-letter">W</span>ith this application's unique collaborative aspect, 
                students are able to <a href="learn.html">access</a> a large variety of quality 
    ...
    <div class="container">
        ...
        <div class="container-body">
            <p> <span class="first-letter">F</span>ill in the <a href="collaborate.html">form</a> on the collaboration page
